          ...
          {group.items.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                aria-current={active ? "page" : undefined}
                className={`flex items-center gap-2.5 rounded-r-xl border-l-2 px-3 py-2.5 text-sm transition-colors ${
                  active
                    ? "border-(--color-accent) bg-(--color-surface-2) font-semibold text-(--color-text)"
